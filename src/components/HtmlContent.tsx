  ...
  return (
    <Scroll html>
      ...
      <div
        ...
        className="project top-0  border-cyan-200  text-cyan-500 shadow-cyan-500/50"
      >
        <div className="project-header">
          <p className="m-5  p-5 text-6xl font-bold">Pay Tracker</p>
          <p className="m-5  p-5 text-2xl text-slate-200">
            An app I built using React, TypeScript, Firebase, and Chakra UI. It
            allows drivers to calculate pay, miles and time off, and stores it
            in a database.
          </p>
          <div className="m-3">
            <a
      ...
      <div
        ...
        className="project top-[550vh] left-[2.5vw] border-amber-200  text-yellow-400 shadow-amber-500/50"
      >
        <div className="project-header">
      ...
      <div
        ...
        className="project top-[750vh] left-[68.5vw]  border-teal-400  text-teal-300 shadow-teal-500/50"
      >
        <div className="project-header">
      ...
      <div
        ...
        className="project top-[950vh] left-[2.5vw] border-fuchsia-300  text-fuchsia-300 shadow-fuchsia-500/50"
      >
        {" "}
        <div className="project-header">
